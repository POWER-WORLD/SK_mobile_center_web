    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 pb-20">
        <HeroSection
          ...
          primaryAction={{ label: "Check Status", onClick: () => window.location.href = 'tel:+916393979967' }}
                ...
                {services.filter(s => s.is_active).map((service, index) => {
                  ...
                  return (
                    <GlassCard key={service.id} className="p-6">
                      ...
                      <button onClick={() => {window.location.href = '/contact';}} className="text-green-600 font-semibold text-sm hover:underline flex items-center gap-1">
                        Book Service &rarr;
                      </button>
                    </GlassCard>
                  );
